...
$definitions["%s has registered and is awaiting approval."] = "%s registou-se e está à espera de ser aprovado.";
...
$definitions["%s tagged you in a post."] = "%s mencionou-te numa publicação.";
...
$definitions["Automatically follow conversations that I reply to"] = "Seguir automaticamente conversas a que eu responda";
$definitions["Automatically follow private conversations that I'm added to"] = "Seguir automaticamente conversas privadas a que eu seja adicionado";
...
$definitions["Administrator username"] = "Utilizador do Administrador";
...
$definitions["Don't allow other users to see when I am online"] = "Não permitir que os outros utilizadores vejam quando estiver ligado";
...
$definitions["Don't require users to confirm their account"] = "Não obrigar os utilizadores a verificar a sua conta";
...
$definitions["Email me when someone mentions me in a post"] = "Envia-me um email quando me mencionarem numa publicação";
$definitions["Email me when someone posts in a channel I have followed"] = "Envia-me um email quando alguém publicar num canal que sigo";
$definitions["Email me when someone posts in a conversation I have followed"] = "Envia-me um email quando alguém publicar numa conversa que eu siga";
$definitions["Email me when there is a new post by a member I have followed"] = "Envia-me um email quando um membro que sigo fizer uma nova publicação";
$definitions["Email"] = "Email";
$definitions["Enable"] = "Ligar";
$definitions["Enabled"] = "Ligado";
$definitions["Enter a conversation title"] = "Introduz um título para a conversa";
...
$definitions["Guests can view the:"] = "Os convidados podem ver:";
...
$definitions["label.sticky"] = "Fixar";
$definitions["Labels"] = "Etiquetas";
$definitions["Last active"] = "Último vez activo";
$definitions["Last active %s"] = "Último vez activo %s";
...
$definitions["Make member and online list visible to:"] = "Tornar lista de membros e de pessoas ligadas visível a:";
...
$definitions["MySQL username"] = "Utilizador de MySQL";
...
$definitions["New posts in the past week"] = "Novas publicações na última semana";
...
$definitions["online"] = "online";
$definitions["Only allow members of this group to see who else is in it"] = "Apenas permitir aos membros do grupo ver quem mais está dentro do mesmo";
...
$definitions["Registration Closed"] = "Registos Fechados";
...
$definitions["Require administrator approval"] = "Obrigar a aprovação de um administrador";
...
$definitions["Unsticky"] = "Desafixar";
...
$definitions["Username"] = "Utilizador";
$definitions["Username or Email"] = "Utilizador ou Email";
...
$definitions["We've logged you in and taken you straight to your forum's administration panel. You're welcome."] = "Entrámos com a tua conta e levámos-te directamente para o painel de administração do fórum. De nada!";
...
// Messages.
$definitions["message.404"] = "Oh - a página que pediste não foi encontrada! Tenta voltar atrás e carregar noutra ligação. Ou outra coisa qualquer.";
$definitions["message.accountNotYetApproved"] = "Ainda nenhum administrador aprovou a tua conta. A paciência é uma virtude!";
$definitions["message.ajaxDisconnected"] = "Não foi possível comunicar com o servidor. Espera uns segundos e <a href='javascript:jQuery.ETAjax.resumeAfterDisconnection()'>tenta outra vez</a>, ou <a href='' onclick='window.location.reload();return false'>recarrega a página</a>.";
$definitions["message.ajaxRequestPending"] = "Hey! Ainda estamos a processar algumas das tuas coisas! Se navegares para fora desta página é possível que percas alterações recentes que tenhas feito, por isso espera só mais uns segundos, ok?";
$definitions["message.avatarError"] = "Ocorreu um problema a transferir o teu avatar. Assegura-te que estás a usar um tipo de imagem válido (like .jpg, .png, or .gif) e que o ficheiro não é mesmo enorme.";
$definitions["message.cannotDeleteLastChannel"] = "Hey, espera aí, não podes apagar o último canal! Para onde é que as conversas iriam? Isso seria um bocado parvo.";
$definitions["message.cannotEditSinceReply"] = "Não podes editar a tua publicação porque alguém lhe respondeu desde que a publicaste.";
$definitions["message.changesSaved"] = "As tuas alterações foram gravadas.";
$definitions["message.channelsHelp"] = "Os canais são usados para categorizar conversas no teu fórum. Podes criar quantos canais achares necessários, e reordená-los ao arrastar e deixar cair na área abaixo.";
$definitions["message.channelSlugTaken"] = "Esta slug já está a ser utilizada por outro canal.";
$definitions["message.confirmDelete"] = "Tens a certeza que queres apagar isto? A sério, não vais conseguir recuperar!";
$definitions["message.confirmDiscardReply"] = "Não gravaste a tua resposta como um rascunho. Pretendes descartá-la?";
$definitions["message.confirmEmail"] = "Antes de começares a usar a tua conta recém-criada, vais precisar de confirmar o teu email. Dentro dos próximos minutos deves receber um email nosso com uma ligação para activares a tua conta.";
$definitions["message.confirmLeave"] = "Hey, não gravaste aquilo que estavas a editar! Se abandonares esta página, vais perder as alterações que fizeste. É isso que queres?";
$definitions["message.connectionError"] = "O esoTalk não se conseguiu ligar ao servidor de MySQL. O erro devolvido foi:<br/>%s";
$definitions["message.conversationDeleted"] = "A conversa foi apagada. Diz lá que não soube bem!";
...
$definitions["message.esoTalkAlreadyInstalled"] = "<strong>O esoTalk já está instalado.</strong><br/><small>Para reinstalar o esotalk, precisas de remover o <strong>config/config.php</strong>.</small>";
$definitions["message.esoTalkUpdateAvailable"] = "Está disponível uma versão nova do esoTalk, %s.";
$definitions["message.esoTalkUpdateAvailableHelp"] = "É recomendado que tenhas sempre a última versão do esoTalk instalada para reduzir o risco de segurança. E, hey, também pode ter coisas novas!";
$definitions["message.esoTalkUpToDate"] = "A tua versão do esoTalk está actualizada.";
$definitions["message.esoTalkUpToDateHelp"] = "Sou um pobre estudante que gastou centenas de horas a desenvolver o esoTalk. Se gostares, considera <a href='%s' target='_blank'>doar</a>.";
$definitions["message.fatalError"] = "<p>O esoTalk encontrou um erro feio que torna impossível fazer o que quer que seja que estejas a fazer. Mas não te sintas mal, - <strong>ficam aqui algumas coisas que podes tentar</strong>:</p>\n<ul>\n<li>Vai lá fora, passeia o cão, toma um café... e depois <strong><a href='%1\$s'>tenta outra vez</a></strong>!</li>\n<li>Se fores o administrador do fórum, então podes <strong>procurar ajuda na <a href='%2\$s'>página do esoTalk</a></strong>.</li>\n<li>Tenta bater no computador - às vezes funciona comigo</li>\n</ul>";
$definitions["message.fatalErrorInstaller"] = "<p>O esoTalk encontrou um erro feio que torna impossível fazer o que quer que seja que estejas a fazer. Mas não te sintas mal, - <strong>ficam aqui algumas coisas que podes tentar</strong>:</p>\n<ul>\n<li><p><strong>Tenta outra vez.</strong> Todos cometemos erros - talvez tenha sido o computador desta vez!</p></li>\n<li><p><strong>Volta atrás e confirma as tuas opções.</strong> Em particular, assegura-te que a informação da base de dados está correcta.</p></li>\n<li><p><strong>Procura ajuda.</strong> Vai até ao <a href='%s'>fórum de suporte do esoTalk</a> e procura a ver se mais alguém está a ter o mesmo problema que tu. Caso contrário, cria uma conversa acerca do teu problema, e inclui os detalhes do erro que estão abaixo.</p></li>\n</ul>";
$definitions["message.fatalErrorUpgrader"] = "<p>O esoTalk encontrou um erro feio que torna impossível fazer o que quer que seja que estejas a fazer. Mas não te sintas mal, - <strong>ficam aqui algumas coisas que podes tentar</strong>:</p>\n<ul>\n<li><p><strong>Tenta outra vez.</strong> Todos cometemos erros - talvez tenha sido o computador desta vez!</p></li>\n<li><p><strong>Procura ajuda.</strong> Vai até ao <a href='%s'>fórum de suporte do esoTalk</a> e procura a ver se mais alguém está a ter o mesmo problema que tu. Caso contrário, cria uma conversa acerca do teu problema, e inclui os detalhes do erro que estão abaixo.</p></li>\n</ul>";
$definitions["message.fileUploadFailed"] = "Alguma coisa correu mal e o ficheiro que escolheste não foi transferido. Talvez seja demasiado grande, ou esteja num formato inválido?";
$definitions["message.fileUploadFailedMove"] = "O ficheiro que transferiste não foi copiado para o seu destino. Contacta o administrador do fórum.";
...
$definitions["message.greaterPHPVersionRequired"] = "O teu servidor necessita de ter <strong>PHP 5.0.0 ou maior</strong> instalado para correr o esoTalk.<br/><small>Actualiza a tua instalação de PHP ou fala com o teu host ou administrador para o fazer.</small>";
$definitions["message.incorrectLogin"] = "Os detalhes de entrada estão incorrectos.";
$definitions["message.incorrectPassword"] = "A password está incorrecta.";
$definitions["message.installerAdminHelp"] = "O esoTalk irá as seguintes informações para configurar a conta do administrador do teu fórum.";
$definitions["message.installerFilesNotWritable"] = "O esoTalk não consegue escrever nos seguintes ficheiros / pastas: <strong>%s</strong>.<br/><small>Para resolver isto, precisas de navegar até estes ficheiros / pastas no teu cliente de FTP e fazer-lhes <strong>chmod</strong> para <strong>777</strong>.</small>";
$definitions["message.installerMySQLHelp"] = "O esoTalk precisa de aceder a uma base de dados MySQL para guardar todas as informações do fórum, como conversas e publicações. Se não tens a certeza acerca de alguns destes detalhes, é possível que tenhas que falar como o teu host.";
$definitions["message.installerWelcome"] = "<p>Bem-vindo ao instalador do esoTalk. Nós precisamos de alguns detalhes teus para ter o teu fórum configurado e pronto a correr.</p>\n<p>Se encontrares algum problema, procura ajuda no <a href='%s'>fórum de suporte do esoTalk</a>.</p>";
$definitions["message.invalidChannel"] = "Seleccionaste um canal inválido!";
$definitions["message.invalidEmail"] = "Parece que este endereço de e-mail não é válido...";
$definitions["message.invalidUsername"] = "Precisas de escolher um nome de utilizador entre 3 e 20 caracteres alfanuméricos.";
$definitions["message.javascriptRequired"] = "Esta página necessita de JavaScript para funcionar. Liga-o e volta a tentar!";
$definitions["message.languageUninstalled"] = "A linguagem foi desinstalada.";
$definitions["message.locked"] = "Hm, parece que esta conversa está <strong>trancada</strong>, por isso não lhe podes responder.";
$definitions["message.loginToParticipate"] = "Para iniciar conversas ou responder a publicações, tens que primeiro entrar.";
$definitions["message.logInToReply"] = "<a href='%1\$s' class='link-login'>Entra</a> ou <a href='%2\$s' class='link-join'>Regista-te</a> para responder!";
$definitions["message.logInToSeeAllConversations"] = "<a href='".URL("user/login")."' class='link-login'>Entra</a> para ver alguns canais ou conversas que possam estar escondidos a convidados.";
$definitions["message.memberNotFound"] = "Hm, parece que não existe qualquer membro com esse nome.";
$definitions["message.memberNoPermissionView"] = "Esse membro não pode ser adicionado porque não tem permissões para ver o canal em que esta conversa se encontra.";
$definitions["message.nameTaken"] = "O nome que inseriste já está a ser utilizado ou é uma palavra reservada.";
$definitions["message.newSearchResults"] = "Surgiu nova actividade que afectou os resultados da tua pesquisa. <a href='%s'>Recarregar</a>";
$definitions["message.noActivity"] = "%s ainda não fez nada neste fórum!";
$definitions["message.noChannels"] = "Não há canais visíveis.";
$definitions["message.noMembersOnline"] = "Actualmente, não há membros ligados.";
$definitions["message.noNotifications"] = "Não tens notificações.";
$definitions["message.noPermission"] = "Não tens permissões para executar esta acção.";
$definitions["message.noPermissionToReplyInChannel"] = "Não tens permissões para responder a conversas neste canal.";
$definitions["message.noPluginsInstalled"] = "Actualmente, não há plugins instalados.";
$definitions["message.noSearchResults"] = "Não foram encontradas conversas que coincidam com a tua pesquisa.";
$definitions["message.noSearchResultsMembers"] = "Não foram encontrados membros que coincidam com a tua pesquisa.";
$definitions["message.noSearchResultsPosts"] = "Não foram encontradas publicações que coincidam com a tua pesquisa.";
$definitions["message.noSkinsInstalled"] = "Actualmente, não há skins instaladas.";
$definitions["message.notWritable"] = "Não é possível escrever em <code>%s</code>. Tenta fazer-lhe <code>chmod</code> para <code>777</code> ou, se não existir, fazer <code>chmod</code> à pasta que o contém.";
$definitions["message.pageNotFound"] = "A página que procuras não foi encontrada.";
$definitions["message.passwordChanged"] = "Ok, a tua password foi alterada. Agora já podes entrar! Ah, e tenta não a perder outra vez!";
$definitions["message.passwordEmailSent"] = "Ok, enviamos-te um email com uma ligação para fazeres reset à tua password. Procura na tua pasta de spam se não vires nada a chegar nos próximos minutos. Sim, às vezes vamos parar ao spam - acreditas nisto?!";
$definitions["message.passwordsDontMatch"] = "As tuas passwords não coincidem.";
$definitions["message.passwordTooShort"] = "A tua password é demasiado pequena.";
$definitions["message.pluginCannotBeEnabled"] = "O plugin <em>%s</em> não foi activado: %s";
$definitions["message.pluginDependencyNotMet"] = "Para activar este plugin, precisas de ter %s versão %s instalado e activo.";
$definitions["message.pluginUninstalled"] = "O plugin foi desinstalado.";
$definitions["message.postNotFound"] = "A publicação de que estás à procura não foi encontrada.";
$definitions["message.postTooLong"] = "A tua publicação é muito, mas muito grande! Demasiado grande! O número de máximo de caracteres permitidos é de %s. Que é muito!";
$definitions["message.preInstallErrors"] = "Foram encontrados os seguintes erros na configuração do esoTalk. Estes necessitam de ser resolvidos antes ser possível continuar a instalação.";
$definitions["message.preInstallWarnings"] = "Foram encontrados os seguintes erros na configuração do esoTalk. É possível continuar a instalação do esoTalk sem os resolver, mas algumas das funcionalidades podem ficar limitadas.";
$definitions["message.reduceNumberOfGambits"] = "Reduz o número de gambits ou termos de pesquisa que estás a usar para pesquisar por uma maior gama de conversas.";
$definitions["message.registerGlobalsWarning"] = "A opção de PHP <strong>register_globals</strong> está activada.<br/><small>Enquanto esta não impede o esoTalk de correr, é recomendado que ela seja desligada para reforçar a segurança e para evitar que surjam problemas com a plataforma.</small>";
$definitions["message.registrationClosed"] = "Os registos neste fórum não estão abertos ao público.";
$definitions["message.removeDirectoryWarning"] = "Hey! Parece que não apagaste a pasta <code>%s</code> como te dissemos para fazer! Fazias bem em apagá-la, só para evitar que hackers façam alguma coisa de mal com ela.";
$definitions["message.safeModeWarning"] = "<strong>O modo de segurança</strong> está activado.<br/><small>Isto poderá potenciar problemas no esoTalk, mas podes ainda assim proceder sem o desligar.</small>";
$definitions["message.searchAllConversations"] = "Tenta pesquisar por esse termo em todas as conversas.";
$definitions["message.setNewPassword"] = "Pronto! Agora, qual é que queres que seja a tua nova password?";
$definitions["message.skinUninstalled"] = "A skin foi desinstalada.";
$definitions["message.suspended"] = "Ouch! Um moderador do fórum <strong>suspendeu</strong> a tua conta. Não é nada porreiro, mas até te tirarem a suspensão, não vais poder fazer muito por aqui. Hey, eles que se lixem!";
$definitions["message.suspendMemberHelp"] = "Suspender %s irá impedir que ele responda a conversas, inicie conversas, e que veja conversas privadas. Efectivamente, ele terá as mesmas permissões que um convidado.";
$definitions["message.tablePrefixConflict"] = "O instalador detectou que existe outra instalação do esoTalk na mesma base de dados de MySQL com o mesmo prefixo de tabelas.<br/>Para escrever por cima desta instalação, carrega em 'Instalar o Meu Fórum' outra vez. <strong>Todos os dados irão ser perdidos.</strong><br/>Se preferires criar outra instalação do esoTalk ao lado da que já existe, <strong>muda o prefixo das tabelas</strong>.";
$definitions["message.unsuspendMemberHelp"] = "Des-suspender %s irá permitir que ele participe nas conversas deste fórum novamente.";
$definitions["message.upgradeSuccessful"] = "O esoTalk foi actualizado.";
$definitions["message.waitForApproval"] = "Antes de começares a usar a tua conta recém-criada, um administrador precisa de a aprovar. Enviar-te-emos um email quando fores aprovado!";
$definitions["message.waitToReply"] = "Tens que esperar pelo menos %s segundos entre iniciar ou responder a conversas. Respira fundo e tenta outra vez.";
$definitions["message.waitToSearch"] = "Woah, abranda! Parece que estás a tentar fazer demasiadas pesquisas. Espera %s segundos e tenta outra vez.";


// Emails.
$definitions["email.header"] = "<p>Hey %s!</p>";
$definitions["email.footer"] = "<p>(Se não quiseres receber mais este tipo de emails, podes <a href='%s'>alterar as tuas preferências de notificações</a>)</p>";

$definitions["email.confirmEmail.subject"] = "%1\$s, confirma o teu endereço de email";
$definitions["email.confirmEmail.body"] = "<p>Alguém (esperançosamente tu!) registou-se no fórum '%1\$s' com este endereço de email.</p><p>Se foste tu, simplesmente visita a seguinte ligação e a tua conta ficará activada:<br/>%4\$s</p>";

$definitions["email.approved.subject"] = "%1\$s, a tua conta foi aprovada";
$definitions["email.approved.body"] = "<p>A tua conta em %1\$s foi aprovada.</p><p>Visita a seguinte ligação para entrares e começares a falar:<br/>%4\$s</p>";

$definitions["email.forgotPassword.subject"] = "Esqueceste-te da tua password, %1\$s?";
$definitions["email.forgotPassword.body"] = "<p>Alguém (esperançosamente tu!) submeteu um pedido de recuperação de password para a tua conta no fórum '%1\$s'. Se não quiseres mudar de password, simplesmente ignora este email.</p><p>Caso contrário, visita a seguinte ligação para a recuperares:<br/><br/>%4\$s</p>";
...
$definitions["email.privateAdd.body"] = "<p>Foste adicionado a uma conversa privada com o título de <strong>%1\$s</strong>.</p><hr>%2\$s<hr><p>Para veres esta conversa, segue a seguinte ligação:<br/>%4\$s</p>";

$definitions["email.post.subject"] = "[Nova Resposta] %1\$s";
$definitions["email.post.body"] = "<p><strong>%1\$s</strong> respondeu a uma conversa que tu segues: <strong>%2\$s</strong></p><hr>%3\$s<hr><p>Para veres a nova actividade, segue a seguinte ligação:<br/>%4\$s</p>";
