...
$definitions["Deleted %s by %s"] = "Apagado %s por %s";
...
$definitions["message.fulltextKeywordWarning"] = "Tem em atenção que palavras chave com menos de 4 caracteres e palavras comuns como 'o' e 'de' não são incluídas nos termos de pesquisa.";
...
$definitions["message.passwordEmailSent"] = "Ok, enviámos-te um email com uma ligação para fazeres reset à tua password. Procura na tua pasta de spam se não vires nada a chegar nos próximos minutos. Sim, às vezes vamos parar ao spam - acreditas nisto?!";
...
$definitions["email.privateAdd.body"] = "<p>Foste adicionado a uma conversa privada com o título de <strong>%1\$s</strong>.</p><hr>%2\$s<hr><p>Para veres esta conversa, segue a seguinte ligação:<br/>%3\$s</p>";
